...
**Ответ:**
  - ![Ответ1](./resources/02.png)
  - [deployment](https://github.com/Vasilenko773/k8s_learning/blob/main/03/deployment.yml).
  - [service-clusterip.yaml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/service-clusterip.yml).
  - [service-nodeport.yaml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/service-nodeport.yml).
...
**Ответ:**
  - ![Ответ1](./resources/03.png)
  - [deployment-backend.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/deployment-backend.yml).
  - [deployment-frontend.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/deployment-frontend.yml).
  - [service-backend.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/service-backend.yml).
  - [service-frontend.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/service-frontend.yml).
  - [ingress.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/03/ingress.yml).
