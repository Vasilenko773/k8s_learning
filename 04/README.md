...
**Ответ:**
  ...
  - [deployment.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/04/deployment.yml).
...
**Ответ:**
  ...
  - [deployment-pvc.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/04/deployment-pvc.yml).
  - [persistentvolume.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/04/persistentvolume.yml).
  - [persistentvolumeclaim.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/04/persistentvolumeclaim.yml).
  - PV не удаляется до тех пор пока не будет удален PVC, так как  PVC ссылается на PV. Если удалить PVC потом можно удалить PV.
  - Файлы из хранилища удалились потому что в манифесте я использую ReclaimPolicy: Recycle
...
**Ответ:**
  - ![Ответ1](./resources/04.png)
  - [storageclass.yml](https://github.com/Vasilenko773/k8s_learning/blob/main/04/storageclass.yml).
